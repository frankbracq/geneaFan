...
(function ($, window, document, undefined) {
    ...
    Timeline.prototype = {
        init: function () {
            ...
            if (contentList.length == 0) {
                var text =
          "There are no events at this point in time. Please add some content.";
            ...
            window.setTimeout(
                $.proxy(function () {
                    ...
                    if (timelineComponents["eventsContentList"].hasClass("selected")) {
                        ...
                        var date = this._timelineData(
                                timelineComponents["eventsContentSelected"],
                                "date"
                            ),
                            // Find the event date matching the date
                            selectedDate = timelineComponents["eventsWrapper"]
                                .find("a")
                                .filter(
                  ...
                  timelineComponents["eventsWrapper"].find("a.selected"),
                            ...
                            timelineComponents["eventsContentList"].filter(
                                $.proxy(function (index, element) {
                                    var data = this._timelineData($(element), "date");
        ...
        _addIdsAndClasses: function (timelineComponents) {
            ...
            if (timelineComponents["eventsContentList"].length == 1) {
                ...
                var bothDefined =
            this._options.animation_baseClass != undefined &&
            this._options.animationClass != undefined,
        ...
        _create: function () {
          ...
          optionArray[5] == undefined,
                ...
                bothDefined =
          (optionArray[0] != undefined &&
            this._options.iconClass != undefined) ||
          (optionArray[1] != undefined &&
            this._options.iconClass != undefined) ||
          (optionArray[2] != undefined &&
            this._options.iconClass != undefined) ||
          ...
          iconClass == this.settings.iconClass
              ? iconClass.base
              : iconClass.iconBaseClass,
                iconScrollLeft =
          iconClass == this.settings.iconClass
              ? iconClass.scrollLeft
              : iconClass.scrollLeft_iconClass,
                iconScrollRight =
          iconClass == this.settings.iconClass
              ? iconClass.scrollRight
              : iconClass.scrollRight_iconClass,
                iconPrev =
          iconClass == this.settings.iconClass
              ? iconClass.prev
              : iconClass.prev_iconClass,
                iconNext =
          iconClass == this.settings.iconClass
              ? iconClass.next
              : iconClass.next_iconClass,
                iconPause =
          iconClass == this.settings.iconClass
              ? iconClass.pause
              : iconClass.pause_iconClass,
                // Left Nav
                $scrollLeftButton =
          '<a href="" class="' +
          iconBase +
          ...
          ' prev inactive"></a>',
                // Right Nav
                $nextButton =
          '<a href="" class="' + iconBase + " " + iconNext + ' next"></a>',
                $scrollRightButton =
          '<a href="" class="' +
          iconBase +
          " " +
          ...
          ' scroll-right"></a>',
                // Pause button
                $pauseButton =
          '<a href="" class="' + iconBase + " " + iconPause + ' pause"></a>';
            ...
            if (
                this.settings.useNavBtns == true ||
        this.settings.useScrollBtns == true
            ) {
                // Add the left nav.
                timelineHTML += '<div class="timeline-navigation" id="leftNav">';

                if (
                    this.settings.useNavBtns == false &&
          this.settings.useScrollBtns == true
                )
                // Add the scroll left button.
                    ...
                    this.settings.useNavBtns == true &&
          this.settings.useScrollBtns == false
                )
                // Add the prev button.
          ...
          this.settings.useScrollBtns == true
                ...
                timelineHTML +=
          '<div class="events-wrapper" style="min-width: 100%"><div class="events"><span class="filling-line" aria-hidden="true"></span></div></div>';
            }
            if (this.settings.autoplay == true)
                timelineHTML +=
          '<div class="timeline-navigation" id="pausePlay">' +
          $pauseButton +
          "</div>";
        ...
        _eventDateDisplay: function (
          ...
          "\"}'>";
            ...
            var dateExists = $eventDateDisplay
                .children("a")
                .map(function () {
                ...
                if (isDateTime) {
                    ...
                    if (typeof customDisplay !== "undefined") {
                        ...
                        if (insertMethod == "append")
                            $eventDateDisplay.append(dateLink + customDisplay + "</a>");
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(dateLink + customDisplay + "</a>");
                        else $arrangementEvent.before(dateLink + customDisplay + "</a>");
                    } else if (dateTimeDisplay) {
                        if (insertMethod == "append")
                            $eventDateDisplay.append(
                                dateLink + date + "<br>" + time + "</a>"
                            );
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(dateLink + date + "<br>" + time + "</a>");
                        else
                            $arrangementEvent.before(
                                dateLink + date + "<br>" + time + "</a>"
                            );
                    } else if (dateDisplay) {
                        if (insertMethod == "append")
                            $eventDateDisplay.append(dateLink + date + "</a>");
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(dateLink + date + "</a>");
                        else $arrangementEvent.before(dateLink + date + "</a>");
                    } else if (timeDisplay) {
                        if (insertMethod == "append")
                            $eventDateDisplay.append(dateLink + time + "</a>");
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(dateLink + time + "</a>");
                  ...
                  "</a>"
                        ...
                        if (insertMethod == "append")
                            $eventDateDisplay.append(
                                dateLink + getMonthName(monthPart) + "<br>" + yearPart + "</a>"
                            );
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(
                        ...
                        if (insertMethod == "append")
                            $eventDateDisplay.append(dateLink + yearPart + "</a>");
                        // For use with the addEvent method... creates new timeline events and places them where specified.
                        else if (insertMethod == "after")
                            $arrangementEvent.after(dateLink + yearPart + "</a>");
        ...
        this.$element.children(".events-content");
            timelineComponents["eventsContentList"] = timelineComponents[
                "eventsContent"
            ].find("li[" + dataAttribute + "]");
            timelineComponents["eventsContentSelected"] = timelineComponents[
                "eventsContent"
            ].find("li[" + dataAttribute + "].selected");

            timelineComponents["timelineWrapper"] = timelineComponents[
                "eventsContent"
            ]
                .parent()
                .find(".events-wrapper");
        ...
        timelineComponents["eventsWrapper"].find("a");
            ...
            timelineComponents["timelineNavigation"] = timelineComponents[
                "timelineWrapper"
            ].siblings(".timeline-navigation");
        },
        ...
        _setup: function (self, timelineComponents, timelineTotalWidth) {
            ...
            function _mobileResizeFix(event) {
                var windowWidth = this.$element.data("plugin_" + this._name)[
                        "windowWidth"
                    ],
            ...
            $(window).on(
                "resize." + this._name + "_" + id,
                debounce($.proxy(this._setup.mobileResizeFix, this), 250)
            );
            ...
            // Button on click...
                .on(
                    "click." + this._name,
                    ".timeline-navigation:not(#pausePlay) a",
                    $.proxy(function (event) {
                        ...
                        if ($this.is(".scroll-left"))
                            this._updateSlide(timelineComponents, timelineTotalWidth, "left");
                    }, this)
                )
            //** Event date function **//
            ...
            '<div class="progressBarWrapper"><div class="progressBar"></div></div>',
                    ...
                    $pauseButton =
            timelineComponents["timelineNavigation"].find(".pause")[0];
                ...
                // On click of the element pause button, pass data to the event [pausebtnClicked, pausebtnHtml, state] and call the changeButtons function.
                    .on(
                        ...
                        [true, $pauseButton, "paused"],
                        $.proxy(this._autoplay.changeButtons, this)
                    )
            ...
            if (goToTimelineLink.length > 0) {
                ...
                function gotoTimeline(event) {
                    ...
                    if (targetSelf) {
                        ...
                        var gotoself =
              "#" + $this.parents(".horizontal-timeline").attr("id");
                    ...
                    if (typeof datagoto !== "undefined") {
                        ...
                        if (typeof dataScrollSpeed !== "undefined")
                            scrollSpeed = dataScrollSpeed;

                        // If offset option exists set offset from the data object
                        if (typeof dataScrollOffset !== "undefined")
                            scrollOffset = dataScrollOffset;

                        // If easing option exists set easing from the data object
                        if (typeof dataScrollEasing !== "undefined")
                            scrollEasing = dataScrollEasing;
                    }
                        ...
                        window.setTimeout(
                            $.proxy(function () {
                                this.$element.on(
                                    ...
                                    ".events-content",
                                    $.proxy(this._setup.mousewheel, this)
                                );
                            }, this),
                            300
          ...
          "https://cdnjs.cloudflare.com/ajax/libs/jquery.touchswipe/1.6.18/jquery.touchSwipe.min.js";
                            ...
                            $.proxy(function () {
                                ...
                                timelineComponents["timelineWrapper"].swipe({
                                    ...
                                    swipeRight: $.proxy(function (
                                        ...
                                        var translateValue = this._getTranslateValue(
                                                timelineComponents["eventsWrapper"]
                                            ),
            ...
            if (this.settings.useKeyboardKeys == true) {
                ...
                // On keyup
                $(document).on(
                    "keyup." + this._name + "_" + id,
                    $.proxy(this._setup.keyboardKeys, this)
                );
        ...
        _autoplay: function (timelineComponents) {
            ...
            // Interval function.
            function interval() {
                isPaused = this.$element.data("plugin_" + this._name)["autoplay"][
                    "isPaused"
                ];
                this._timelineComponents(timelineComponents);
                ...
                if (isPaused === false && this._elementInViewport(this.element)) {
                    ...
                    current = timelineComponents["eventsWrapper"]
                        .find(".selected")
                        .index();
                    ...
                    if (percentTime >= 100) {
                        ...
                        if (
                            (this.settings.dateOrder == "normal" &&
                current == this._autoplay.countEvents()) ||
              (this.settings.dateOrder == "reverse" && current == 1)
                        ) {
            ...
            // Pause function
            function pause(self) {
                self.$element.data("plugin_" + self._name)["autoplay"][
                    "isPaused"
                ] = true;
            }
            // Resume function
            ...
            this._options.iconClass != undefined
                ? iconClass.play
                : iconClass.play_iconClass,
                    // Define the play button html
                    $playButton =
            '<a href="" class="' + iconBase + " " + iconPlay + ' play"></a>';
                ...
                if (event.type == "click" && pausebtnClicked == true) {
                    ...
                    this.$element.data("plugin_" + this._name)["autoplay"]["mouseEvent"] =
            "click";
                ...
                // Else if the event type is click and pausebtnClicked is false (so the play button was clicked)...
                    ...
                    this.$element.data("plugin_" + this._name)["autoplay"][
                        "mouseEvent"
                    ] = false;
     ...
     */
        destroy: function () {
            var $this = this.$element,
                id = $this.attr("id"),
                originalEventsContent = $this.data("plugin_" + this._name)[
            ...
            $this
                ...
                .end()
                .find(".events-content")
                .replaceWith(originalEventsContent)
                .swipe("destroy");
     ...
     */
        addEvent: function (html, insertMethod, arrangementDate) {
            ...
            var newDate = html.split("date")[1].split('"')[2],
                ...
                $eventContent = timelineComponents["eventsContentList"].filter(
                    $.proxy(function (index, element) {
                        var data = this._timelineData($(element), "date");
                ...
                existingDates = this.$element.data("plugin_" + this._name)[
                    "existingDates"
                ];
            ...
            if (jQuery.inArray(newDate, existingDates) == -1) {
                ...
                return console.warn("The date " + newDate + " is already in Timeline.");
        },
     ...
     */
        removeEvent: function (date) {
            ...
            var $event = timelineComponents["eventsWrapper"].find("a").filter(
                    $.proxy(function (index, element) {
                        var data = this._timelineData($(element), "date");
                        if (data == date) return $(element);
                    }, this)
     ...
     */
        ...
        goTo: function (
            date,
            { smoothScroll = false, speed = 500, offset = 0, easing = "linear" } = {},
            instanceRef
        ) {
            var timelineComponents = {};
            this._timelineComponents(timelineComponents);
            ...
            // Get the existing dates array.
            var existingDates = this.$element.data("plugin_" + this._name)[
                "existingDates"
            ];
            (speed = Number(speed)), (offset = Number(offset));
         ...
         */
                ...
                var prevDates = timelineComponents["eventsWrapper"].find("a"),
                    ...
                    selectedDate = timelineComponents["eventsWrapper"].find("a").filter(
                        $.proxy(function (index, element) {
                            var data = this._timelineData($(element), "date");
                            if (data == date) return $(element);
                        }, this)
            ...
            function goto(instanceRef) {
                ...
                if (!selectedDate.hasClass("selected")) {
                    ...
                    instanceRef._updateFilling(
                        selectedDate,
                        timelineComponents["fillingLine"],
                        timelineTotalWidth
                    );
                    // Update the visible content of the selected event
                    instanceRef._updateVisibleContent(
                        selectedDate,
                        timelineComponents["eventsContent"]
                    );
                }
        ...
        timelineComponents["eventsContent"].find(".selected");
          ...
          string == "next" ? visibleContent.next() : visibleContent.prev();
            ...
            // Find the prev/next content in reverse fore detection later.
                var newContent =
          string == "next" ? visibleContent.prev() : visibleContent.next();
            ...
            if (
                newContent.length > 0 ||
        (this.settings.dateOrder == "reverse" && string == "start")
            ) {
                // Find the .selected event
                var selectedDate =
        ...
        _updateTimelinePosition: function (
            event,
            timelineComponents,
            timelineTotalWidth
        ) {
        ...
        _translateTimeline: function (
            ...
            value =
        !(typeof totalTranslateValue === "undefined") &&
        value < totalTranslateValue
            ? totalTranslateValue
            : value;
        ...
        _setDatePosition: function (timelineComponents) {
            ...
            var checkMQ = this._checkMQ(),
                ...
                // otherwise use the deprecated single options.
                minimal =
          this._options.dateIntervals != undefined
              ? this.settings.dateIntervals.minimal
              : this.settings.minimalFirstDateInterval;
            ...
            for (
                i = startingNum;
                i < timelineComponents["timelineEvents"].length;
                i++
            ) {
        ...
        _updateVisibleContent: function (event, eventsContent) {
            ...
            (newContent = eventsContent.find("li[" + dataAttribute + "]").filter(
                $.proxy(function (index, element) {
                    var data = this._timelineData($(element), "date");
            ...
            // Set the single options into an array to check against.
            (optionArray = [
                this._options.enter_animationClass,
                this._options.exit_animationClass,
            ]),
            // A variable to include in an if statement that queries if the single options are undefined.
            (singleUndefined =
          optionArray[0] == undefined && optionArray[1] == undefined),
            // A variable to include in an if statement that queries if the single option is defined
            // AND the object option is also defined.
            (bothDefined =
          (optionArray[0] != undefined &&
          ...
          animationObj == this.settings.animationClass
              ? animationObj.enter
              : animationObj.enter_animationClass),
            (exitObj =
          animationObj == this.settings.animationClass
              ? animationObj.exit
              : animationObj.exit_animationClass),
            (allClasses =
          exitObj.right +
          " " +
          exitObj.left +
        ...
        _setDateIntervals: function (timelineComponents) {
            var checkMQ = this._checkMQ(),
                ...
                // Set the single options into an array to check against.
                optionArray = [
                    this._options.desktopDateIntervals,
                    this._options.tabletDateIntervals,
                    this._options.mobileDateIntervals,
                ],
                // A variable to include in an if statement that queries if the single options are undefined.
                singleUndefined =
          optionArray[0] == undefined &&
          ...
          (optionArray[2] != undefined &&
            this._options.dateIntervals != undefined),
                ...
                date_intervals =
          singleUndefined || bothDefined
              ? this.settings.dateIntervals
              : this.settings,
                // If date_intervals equals the object options...
                desktop =
          date_intervals == this.settings.dateIntervals
              ? date_intervals.desktop
              : date_intervals.desktopDateIntervals,
                tablet =
          date_intervals == this.settings.dateIntervals
              ? date_intervals.tablet
              : date_intervals.tabletDateIntervals,
                mobile =
          date_intervals == this.settings.dateIntervals
              ? date_intervals.mobile
              : date_intervals.mobileDateIntervals;
        ...
        _buttonStates: function (
            ...
            var nextButton = timelineComponents["timelineNavigation"].find(".next"),
                ...
                leftButton =
          timelineComponents["timelineNavigation"].find(".scroll-left"),
                rightButton =
          timelineComponents["timelineNavigation"].find(".scroll-right"),
            ...
            if (translateValue == totalTranslateValue)
                rightButton.addClass("inactive");
                ...
                if (loadedFile.indexOf(url) == -1 && !fileExists.length) {
                    ...
                    if (js) {
                        console.groupCollapsed(
                            name + " on " + this.$element.attr("id") + " timeline"
                        );
                    ...
                    // Else if adding CSS...
                        ...
                        $("<link>")
                            ...
                            .insertAfter($("head").find("link").last());
    ...
    $.fn[pluginName] = function (options) {
        var args = arguments,
            ...
            // data-date deprecated as of v2.0.5.alpha.3
            // and will be removed in a later major version.
            dataAttribute = $(this).find("li").data("horizontal-timeline")
                ? "data-horizontal-timeline"
                : "data-date",
            dateExists = $(this)
                .find(".events-content")
                .find("li[" + dataAttribute + "]")
