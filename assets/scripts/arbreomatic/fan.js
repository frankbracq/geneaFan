...
function drawFan(json, config) {
    ...
    const weightRadiusFirst = config.weights.generations[0],
        ...
        weightRadiusMarriage = showMarriages ? 0.2 : 0;
    const weightFontFirst = 0.25,
        weightFontOther = 0.2,
        weightFontFar = 0.1,
        weightFontFurthest = 0.06,
        weightFontMarriage = 0.15;
    const thirdLevel = 4,
        fourthLevel = 5,
        fifthLevel = 6,
        sixthLevel = 7,
    ...
    const isMarriageFirst = d => between(0, fourthLevel)(d) && d.children,
